...
class _HomeViewState extends State<HomeView> {
  ...
  Future<void> fetchRestaurantData() async {
    try {
      // Make HTTP GET request to fetch restaurant details
      final response = await http.get(Uri.parse(SVKey.mainUrl + '/restaurants'));
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          // Initialize the restaurants list as an empty list
          restaurants = [];

          // Add each restaurant as a map to the restaurants list
  ...
  void printRestaurants() {
    ...
    for (var restaurant in restaurants) {
      ...
      print('  Type: ${restaurant['shop_type']}');
      print('  Food Type: ${restaurant['food_type']}');
